                                    ...
                                    rmt_encoder_handle_t *ret_encoder)
{
    ...
    ESP_RETURN_ON_FALSE(led_encoder, ESP_ERR_NO_MEM, TAG,
                        "Không đủ bộ nhớ cho encoder");

    led_encoder->base.encode  = rmt_encode_led_strip;
    led_encoder->base.del     = rmt_del_led_strip_encoder;
    led_encoder->base.reset   = rmt_led_strip_encoder_reset;

    /* Tính số tick cho mỗi thời gian (resolution = Hz) */
    uint32_t res = config->resolution;
    /* WS2812B timing (nanoseconds):
     *   T0H=400 T0L=850 T1H=850 T1L=450 */
    rmt_bytes_encoder_config_t bytes_encoder_config = {
        .bit0 = {
            .level0    = 1,
            .duration0 = (uint16_t)(0.4e-6 * res),  // T0H
            .level1    = 0,
            .duration1 = (uint16_t)(0.85e-6 * res), // T0L
        },
        .bit1 = {
            .level0    = 1,
            .duration0 = (uint16_t)(0.85e-6 * res), // T1H
            .level1    = 0,
            .duration1 = (uint16_t)(0.45e-6 * res), // T1L
        },
        .flags.msb_first = 1,
    };

    esp_err_t ret = rmt_new_bytes_encoder(&bytes_encoder_config,
