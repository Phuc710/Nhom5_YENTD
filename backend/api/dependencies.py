...
"""
from backend.api.services.alpr_service import ALPRService
from backend.api.services.stream_manager import StreamManager
from backend.api.services.db_service import DBService
from backend.api.services.mqtt_service import MQTTService
from backend.api.services.local_settings_service import LocalSettingsService, local_settings as _local_settings_instance
from backend.api.services.image_service import ImageService
