...
from backend.api.models import ViolationCreateRequest, OCRResultRequest, MessageResponse
from backend.api.services.db_service import DBService
from backend.api.services.image_service import ImageService
from backend.api.dependencies import get_db_service, get_image_service
...
async def get_snapshot_webp(
    ...
    from backend.api.dependencies import stream_manager
