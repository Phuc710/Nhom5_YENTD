...
from backend.api.dependencies import alpr_service, stream_manager, db_service, mqtt_service, local_settings, image_service
...
from backend.api.routes.predict import reset_router
...
from backend.api.routes.mqtt import router as mqtt_router
from backend.api.routes.settings import router as settings_router
from backend.api.routes.local_settings import router as local_settings_router
